...
[W3C browser and robotics CGの Web GPIO API Draft](https://github.com/browserobo/WebGPIO) に準拠した、物理コンピューティングのためのNode.js向けGPIOドライバです。CHIRIMEN環境などでの利用を想定し、従来のAPI互換性を保ちながら、バックエンドの駆動方式を抜本的に刷新しました。
